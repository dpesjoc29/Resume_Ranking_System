...
GOOGLE_CLIENT_ID = "265168634975-jp39a6t5gjdmbtcr90q4r9p2gei6jl5l.apps.googleusercontent.com"
...
app.config['MONGO_URI']="mongodb+srv://dpesjoc29:dpesjoc29@cluster0.f3jqwba.mongodb.net/test"
mongo.init_app(app)
    ...
    if 'user_id' in session and 'user_name' in session:
        try:
            ...
            if file and allowedExtension(file.filename):
                ...
                print("check 1")
                print(extractorObj.extractorData)
                print("static/resumes/"+filename,file.filename.rsplit('.',1)[1].lower())

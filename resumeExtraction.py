...
class resumeExtraction:
    ...
    def extractorData(self,file,ext): #
        ...
        # print(name,mobile_no,email,skills,education1,text1)
        return (name,mobile_no,email,skills,education1,text1)

resumeExtractor = resumeExtraction()
# print(resumeExtractor)
# print(resumeExtractor.extractorData(fitz.open('D:/Major_Project/ResumeRanker_Shared/static/resumes/Aishwarya_Resume.pdf'),"pdf"))
